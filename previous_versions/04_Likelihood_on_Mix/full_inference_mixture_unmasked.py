...
def main():
    parser = argparse.ArgumentParser(description="Full TSE Pipeline: Discriminative Extraction + Unmasked Mixture Guidance Refinement")
    ...
    print("\n" + "="*60)
    print("PHASE 2: Generative Refinement (Unmasked Mixture Guidance)")
    print("="*60)
    
    import refine_arraydps_mixture_unmasked
    
    refine_arraydps_mixture_unmasked.run_storm_refinement(
    ...
    print(f"\nSUCCESS! Stage 4 (Unmasked Mixture Guidance) pipeline complete. Final audio saved to: {args.output}")
