...
def main():
    parser = argparse.ArgumentParser(description="Full TSE Pipeline: Discriminative Extraction + Joint Mixture Guidance Generative Refinement")
    ...
    print("\n" + "="*50)
    print("PHASE 2: Generative Refinement (Joint Mixture Guidance)")
    print("="*50)
    
    import refine_arraydps_mixture
    
    refine_arraydps_mixture.run_storm_refinement(
    ...
    print(f"\nSUCCESS! Full Joint Mixture Guidance pipeline complete. Final audio saved to: {args.output}")
