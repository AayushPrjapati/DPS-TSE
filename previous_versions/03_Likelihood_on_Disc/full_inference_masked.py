...
def main():
    parser = argparse.ArgumentParser(description="Full TSE Pipeline: Discriminative Extraction + Masked DPS Generative Refinement")
    ...
    print("\n" + "="*50)
    print("PHASE 2: Generative Refinement (Masked DPS Inpainting)")
    print("="*50)
    
    import refine_arraydps_masked
    
    refine_arraydps_masked.run_storm_refinement(
    ...
    print(f"\nSUCCESS! Full Masked DPS pipeline complete. Final audio saved to: {args.output}")
